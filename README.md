...
3. From the CET overlay, fill out the fields with your ```Archipelago Server IP/URL```, ```Archipelago Server Port```, ```Save Slot Name```, and optionally ```Password``` if your slot is password-protected
4. Profit. Have Fun.
