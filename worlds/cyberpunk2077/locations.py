...
location_table: Dict[str, LocationData] = {
    ...
    "VendorCheck_CctDtnRipdoc_1": LocationData(display_name="Downtown Ripperdoc (Darius Clarke) 1", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CctDtnRipdoc_2": LocationData(display_name="Downtown Ripperdoc (Darius Clarke) 2", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CctDtnRipdoc_3": LocationData(display_name="Downtown Ripperdoc (Darius Clarke) 3", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_HeySprRipperdoc_1": LocationData(display_name="Wellsprings Ripperdoc (Santiago Molina) 1", regions=("Heywood",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_HeySprRipperdoc_2": LocationData(display_name="Wellsprings Ripperdoc (Santiago Molina) 2", regions=("Heywood",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_HeySprRipperdoc_3": LocationData(display_name="Wellsprings Ripperdoc (Santiago Molina) 3", regions=("Heywood",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_PacWwdRipperdoc_1": LocationData(display_name="West Wind Estate Ripperdoc (Rony LaFleur) 1", regions=("Pacifica",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_PacWwdRipperdoc_2": LocationData(display_name="West Wind Estate Ripperdoc (Rony LaFleur) 2", regions=("Pacifica",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_PacWwdRipperdoc_3": LocationData(display_name="West Wind Estate Ripperdoc (Rony LaFleur) 3", regions=("Pacifica",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_CzConRipdoc_1": LocationData(display_name="Dogtown Ripperdoc (Eron Acedo) 1", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CzConRipdoc_2": LocationData(display_name="Dogtown Ripperdoc (Eron Acedo) 2", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CzConRipdoc_3": LocationData(display_name="Dogtown Ripperdoc (Eron Acedo) 3", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_CzMonumentAnderson_1": LocationData(display_name="Dogtown Ripperdoc (Anthony Anderson) 1", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CzMonumentAnderson_2": LocationData(display_name="Dogtown Ripperdoc (Anthony Anderson) 2", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CzMonumentAnderson_3": LocationData(display_name="Dogtown Ripperdoc (Anthony Anderson) 3", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_CzMonumentFarida_1": LocationData(display_name="Dogtown Ripperdoc (Farida Nazeri) 1", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CzMonumentFarida_2": LocationData(display_name="Dogtown Ripperdoc (Farida Nazeri) 2", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_CzMonumentFarida_3": LocationData(display_name="Dogtown Ripperdoc (Farida Nazeri) 3", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_StdArrRipperdoc_1": LocationData(display_name="Arroyo Ripperdoc (Rafael Pérez) 1", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_StdArrRipperdoc_2": LocationData(display_name="Arroyo Ripperdoc (Rafael Pérez) 2", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_StdArrRipperdoc_3": LocationData(display_name="Arroyo Ripperdoc (Rafael Pérez) 3", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    "VendorCheck_StdRcrRipperdoc_1": LocationData(display_name="Rancho Coronado Ripperdoc (Octavio) 1", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_StdRcrRipperdoc_2": LocationData(display_name="Rancho Coronado Ripperdoc (Octavio) 2", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_StdRcrRipperdoc_3": LocationData(display_name="Rancho Coronado Ripperdoc (Octavio) 3", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    ...
    "VendorCheck_WbrHilRipdoc_1": LocationData(display_name="Charter Hill Ripperdoc (Nina Kraviz) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_WbrHilRipdoc_2": LocationData(display_name="Charter Hill Ripperdoc (Nina Kraviz) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="ripperdoc"),
    "VendorCheck_WbrHilRipdoc_3": LocationData(display_name="Charter Hill Ripperdoc (Nina Kraviz) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="ripperdoc"),
    ...
    "VendorCheck_StdRcrGunsmith_1": LocationData(display_name="Rancho Coronado Weapon Vendor (Gun-O-Rama) 1", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_StdRcrGunsmith_2": LocationData(display_name="Rancho Coronado Weapon Vendor (Gun-O-Rama) 2", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_StdRcrGunsmith_3": LocationData(display_name="Rancho Coronado Weapon Vendor (Gun-O-Rama) 3", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="gunsmith"),
    "VendorCheck_WatNidGunsmith_1": LocationData(display_name="Northside Weapon Vendor (Iron & Lead) 1", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_WatNidGunsmith_2": LocationData(display_name="Northside Weapon Vendor (Iron & Lead) 2", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_WatNidGunsmith_3": LocationData(display_name="Northside Weapon Vendor (Iron & Lead) 3", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_WbrJpnGunsmith_1": LocationData(display_name="Japantown Weapon Vendor (Rifles & Pistols) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_WbrJpnGunsmith_2": LocationData(display_name="Japantown Weapon Vendor (Rifles & Pistols) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_WbrJpnGunsmith_3": LocationData(display_name="Japantown Weapon Vendor (Rifles & Pistols) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="gunsmith"),
    "VendorCheck_BlsInaSe1Gunsmith01a_1": LocationData(display_name="Jackson Plains Weapon Vendor (Marty Jenklow) 1", regions=("Badlands",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_BlsInaSe1Gunsmith01a_2": LocationData(display_name="Jackson Plains Weapon Vendor (Marty Jenklow) 2", regions=("Badlands",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="gunsmith"),
    "VendorCheck_BlsInaSe1Gunsmith01a_3": LocationData(display_name="Jackson Plains Weapon Vendor (Marty Jenklow) 3", regions=("Badlands",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="gunsmith"),
    ...
    "VendorCheck_CctCpzClothing_1": LocationData(display_name="Corpo Plaza Clothing Vendor (Appel de Paris) 1", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_CctCpzClothing_2": LocationData(display_name="Corpo Plaza Clothing Vendor (Appel de Paris) 2", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_CctCpzClothing_3": LocationData(display_name="Corpo Plaza Clothing Vendor (Appel de Paris) 3", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    "VendorCheck_CctDtnClothing_1": LocationData(display_name="Downtown Clothing Vendor (Jinguji) 1", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_CctDtnClothing_2": LocationData(display_name="Downtown Clothing Vendor (Jinguji) 2", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_CctDtnClothing_3": LocationData(display_name="Downtown Clothing Vendor (Jinguji) 3", regions=("City Center",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    "VendorCheck_HeySprClothing_1": LocationData(display_name="Wellsprings Clothing Vendor (Stylishly) 1", regions=("Heywood",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_HeySprClothing_2": LocationData(display_name="Wellsprings Clothing Vendor (Stylishly) 2", regions=("Heywood",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_HeySprClothing_3": LocationData(display_name="Wellsprings Clothing Vendor (Stylishly) 3", regions=("Heywood",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    ...
    "VendorCheck_StdRcrClothing_1": LocationData(display_name="Rancho Coronado Clothing Vendor (Stylishly) 1", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_StdRcrClothing_2": LocationData(display_name="Rancho Coronado Clothing Vendor (Stylishly) 2", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_StdRcrClothing_3": LocationData(display_name="Rancho Coronado Clothing Vendor (Stylishly) 3", regions=("Santo Domingo",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    ...
    "VendorCheck_WatLchClothing_1": LocationData(display_name="Little China Clothing Vendor (Stylishly) 1", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WatLchClothing_2": LocationData(display_name="Little China Clothing Vendor (Stylishly) 2", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WatLchClothing_3": LocationData(display_name="Little China Clothing Vendor (Stylishly) 3", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WatNidClothing_1": LocationData(display_name="Northside Clothing Vendor (Ded Zed) 1", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WatNidClothing_2": LocationData(display_name="Northside Clothing Vendor (Ded Zed) 2", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WatNidClothing_3": LocationData(display_name="Northside Clothing Vendor (Ded Zed) 3", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrHilClothing_1": LocationData(display_name="Charter Hill Clothing Vendor (Avante) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrHilClothing_2": LocationData(display_name="Charter Hill Clothing Vendor (Avante) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrHilClothing_3": LocationData(display_name="Charter Hill Clothing Vendor (Avante) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    "VendorCheck_WbrJpnClothing01_1": LocationData(display_name="Japantown Clothing Vendor (Saeko's) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrJpnClothing01_2": LocationData(display_name="Japantown Clothing Vendor (Saeko's) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrJpnClothing01_3": LocationData(display_name="Japantown Clothing Vendor (Saeko's) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    "VendorCheck_WbrJpnClothing02_1": LocationData(display_name="Japantown Clothing Vendor (Karim Noel) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrJpnClothing02_2": LocationData(display_name="Japantown Clothing Vendor (Karim Noel) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="clothing"),
    "VendorCheck_WbrJpnClothing02_3": LocationData(display_name="Japantown Clothing Vendor (Karim Noel) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="clothing"),
    ...
    "VendorCheck_PacCviMelee_1": LocationData(display_name="Coastview Melee Vendor (Animals) 1", regions=("Pacifica",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    "VendorCheck_PacCviMelee_2": LocationData(display_name="Coastview Melee Vendor (Animals) 2", regions=("Pacifica",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    "VendorCheck_PacCviMelee_3": LocationData(display_name="Coastview Melee Vendor (Animals) 3", regions=("Pacifica",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="melee"),
    ...
    "VendorCheck_WatLchMelee01_1": LocationData(display_name="Little China Melee Vendor (Coach Fred) 1", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    "VendorCheck_WatLchMelee01_2": LocationData(display_name="Little China Melee Vendor (Coach Fred) 2", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    "VendorCheck_WatLchMelee01_3": LocationData(display_name="Little China Melee Vendor (Coach Fred) 3", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    ...
    "VendorCheck_WbrJpnMelee_1": LocationData(display_name="Japantown Melee Vendor (Spector Cheng) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    "VendorCheck_WbrJpnMelee_2": LocationData(display_name="Japantown Melee Vendor (Spector Cheng) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="melee"),
    "VendorCheck_WbrJpnMelee_3": LocationData(display_name="Japantown Melee Vendor (Spector Cheng) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="melee"),
    ...
    "VendorCheck_WatLchNetrunner_1": LocationData(display_name="Little China Netrunner (Nix) 1", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    "VendorCheck_WatLchNetrunner_2": LocationData(display_name="Little China Netrunner (Nix) 2", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    "VendorCheck_WatLchNetrunner_3": LocationData(display_name="Little China Netrunner (Nix) 3", regions=("Watson",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    ...
    "VendorCheck_WbrJpnNetrunner01_1": LocationData(display_name="Japantown Netrunner (Chang-Hoon Nam) 1", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    "VendorCheck_WbrJpnNetrunner01_2": LocationData(display_name="Japantown Netrunner (Chang-Hoon Nam) 2", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    "VendorCheck_WbrJpnNetrunner01_3": LocationData(display_name="Japantown Netrunner (Chang-Hoon Nam) 3", regions=("Westbrook",), category=LocationCategory.VENDOR, progress_type=LocationProgressType.PRIORITY, vendor_subtype="netrunner"),
    ...
    "VendorCheck_CzConNetrunner_1": LocationData(display_name="Dogtown Netrunner (Sammy Taylor) 1", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    "VendorCheck_CzConNetrunner_2": LocationData(display_name="Dogtown Netrunner (Sammy Taylor) 2", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.EXCLUDED, vendor_subtype="netrunner"),
    "VendorCheck_CzConNetrunner_3": LocationData(display_name="Dogtown Netrunner (Sammy Taylor) 3", regions=("Dogtown",), category=LocationCategory.VENDOR, dlc_only=True, progress_type=LocationProgressType.PRIORITY, vendor_subtype="netrunner"),
}
